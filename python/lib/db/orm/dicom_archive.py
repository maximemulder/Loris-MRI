...
class DicomArchive(Base):
    ...
    series                   : Mapped[List['dicom_archive_series.DicomArchiveSeries']] = relationship('DicomArchiveSeries', back_populates='archive')
    files                    : Mapped[List['dicom_archive_file.DicomArchiveFile']] = relationship('DicomArchiveFile', back_populates='archive')
    upload                   : Mapped[Optional['mri_upload.MriUpload']] = relationship('MriUpload', back_populates='dicom_archive')
